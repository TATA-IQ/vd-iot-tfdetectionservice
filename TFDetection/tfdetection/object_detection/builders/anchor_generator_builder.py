...
def build(anchor_generator_config):
    ...
    if anchor_generator_config.WhichOneof("anchor_generator_oneof") == "grid_anchor_generator":
        ...
        if ssd_anchor_generator_config.height_stride:
            anchor_strides = list(
                zip(ssd_anchor_generator_config.height_stride, ssd_anchor_generator_config.width_stride)
            )
        anchor_offsets = None
        if ssd_anchor_generator_config.height_offset:
            anchor_offsets = list(
                zip(ssd_anchor_generator_config.height_offset, ssd_anchor_generator_config.width_offset)
            )
