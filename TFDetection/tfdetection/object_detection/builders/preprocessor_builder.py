...
def build(preprocessor_step_config):
    ...
    if step_type == "random_horizontal_flip":
        ...
        return (
            ...
            {
                "keypoint_flip_permutation": tuple(config.keypoint_flip_permutation) or None,
    ...
    if step_type == "random_rotation90":
        ...
        return (
            ...
            {
                "keypoint_rot_permutation": tuple(config.keypoint_rot_permutation) or None,
                "probability": config.probability or None,
            },
        )
    ...
    if step_type == "resize_image":
        ...
        return (
            ...
            {"new_height": config.new_height, "new_width": config.new_width, "method": method},
        )
