...
tf.flags.DEFINE_string(
    "model",
    "resnet_v2_101",
    'The model to load. The following are supported: "resnet_v1_50", "resnet_v1_101", "resnet_v2_50", "resnet_v2_101"',
)
tf.flags.DEFINE_string("output_path", None, "The directory to output weights in.")
tf.flags.DEFINE_boolean(
    "verify_weights",
    True,
    "Verify the weights are loaded correctly by making sure the predictions are the same before and after saving.",
)
