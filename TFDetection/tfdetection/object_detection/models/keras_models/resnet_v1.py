    ...
    def BatchNormalization(self, **kwargs):  # pylint: disable=invalid-name
        ...
        if self._conv_hyperparams:
            ...
            return freezable_batch_norm.FreezableBatchNorm(
                training=self._batchnorm_training, momentum=self._default_batchnorm_momentum, **kwargs
            )
...
def block_basic(x, filters, kernel_size=3, stride=1, conv_shortcut=False, name=None):
    ...
    x = layers.Conv2D(filters, kernel_size, strides=1, use_bias=False, name=name + "_1_conv")(x)
