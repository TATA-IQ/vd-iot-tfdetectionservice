...
class SSDResnetFPNFeatureExtractorTestBase(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
    ...
    def _create_feature_extractor(
        self, depth_multiplier, pad_to_multiple, use_explicit_padding=False, min_depth=32, use_keras=False
    ):
        pass
    ...
    def test_extract_features_returns_correct_shapes_with_min_depth(self):
        ...
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_extractor = self._create_feature_extractor(
                depth_multiplier, pad_to_multiple, min_depth=min_depth, use_keras=self.is_tf2()
            )
    ...
    def test_extract_features_raises_error_with_invalid_image_size(self):
        ...
        self.check_extract_features_raises_error_with_invalid_image_size(
            image_height, image_width, depth_multiplier, pad_to_multiple, use_keras=self.is_tf2()
        )
    ...
    def test_preprocess_returns_correct_value_range(self):
        ...
        self.assertAllClose(preprocessed_image_out, test_image_np - [[123.68, 116.779, 103.939]])
    ...
    def test_variable_count(self):
        ...
        depth_multiplier = 1
        pad_to_multiple = 1
        variables = self.get_feature_extractor_variables(depth_multiplier, pad_to_multiple, use_keras=self.is_tf2())
