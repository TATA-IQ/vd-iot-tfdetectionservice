...
from object_detection.protos import \
    center_net_pb2 as object__detection_dot_protos_dot_center__net__pb2
from object_detection.protos import \
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        b'\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a(object_detection/protos/center_net.proto\x1a)object_detection/protos/faster_rcnn.proto\x1a!object_detection/protos/ssd.proto"\x86\x02\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01'
        b" \x01(\x0b\x32#.object_detection.protos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02"
        b" \x01(\x0b\x32\x1c.object_detection.protos.SsdH\x00\x12H\n\x12\x65xperimental_model\x18\x03"
        b" \x01(\x0b\x32*.object_detection.protos.ExperimentalModelH\x00\x12\x38\n\ncenter_net\x18\x04"
        b' \x01(\x0b\x32".object_detection.protos.CenterNetH\x00\x42\x07\n\x05model"!\n\x11\x45xperimentalModel\x12\x0c\n\x04name\x18\x01'
        b" \x01(\t"
    ),
    dependencies=[
        object__detection_dot_protos_dot_center__net__pb2.DESCRIPTOR,
...
_DETECTIONMODEL = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="center_net",
            full_name="object_detection.protos.DetectionModel.center_net",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_DETECTIONMODEL.oneofs_by_name["model"].fields.append(_DETECTIONMODEL.fields_by_name["center_net"])
