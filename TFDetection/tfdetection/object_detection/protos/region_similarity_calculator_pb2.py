...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        b'\n:object_detection/protos/region_similarity_calculator.proto\x12\x17object_detection.protos"\xde\x02\n\x1aRegionSimilarityCalculator\x12N\n\x16neg_sq_dist_similarity\x18\x01'
        b" \x01(\x0b\x32,.object_detection.protos.NegSqDistSimilarityH\x00\x12@\n\x0eiou_similarity\x18\x02"
        b" \x01(\x0b\x32&.object_detection.protos.IouSimilarityH\x00\x12@\n\x0eioa_similarity\x18\x03"
        b" \x01(\x0b\x32&.object_detection.protos.IoaSimilarityH\x00\x12W\n\x1athresholded_iou_similarity\x18\x04"
        b' \x01(\x0b\x32\x31.object_detection.protos.ThresholdedIouSimilarityH\x00\x42\x13\n\x11region_similarity"\x15\n\x13NegSqDistSimilarity"\x0f\n\rIouSimilarity"\x0f\n\rIoaSimilarity"6\n\x18ThresholdedIouSimilarity\x12\x1a\n\riou_threshold\x18\x01'
        b" \x01(\x02:\x03\x30.5"
    ),
)
