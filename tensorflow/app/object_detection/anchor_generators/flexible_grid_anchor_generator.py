...
class FlexibleGridAnchorGenerator(anchor_generator.AnchorGenerator):
    ...
    def _generate(self, feature_map_shape_list, im_height=1, im_width=1):
        ...
        """
        anchor_grid_list = []
        for feat_shape, base_sizes, aspect_ratios, anchor_stride, anchor_offset in zip(
            feature_map_shape_list, self._base_sizes, self._aspect_ratios, self._anchor_strides, self._anchor_offsets
        ):
