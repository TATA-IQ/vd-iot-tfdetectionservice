...
from object_detection.anchor_generators import (
    flexible_grid_anchor_generator, grid_anchor_generator,
    multiple_grid_anchor_generator, multiscale_grid_anchor_generator)
...
class AnchorGeneratorBuilderTest(tf.test.TestCase):
    ...
    """
        ...
        for actual_scales, expected_scales in zip(
            ...
            [(0.1, 0.2, 0.2), (0.35, 0.418), (0.499, 0.570), (0.649, 0.721), (0.799, 0.871), (0.949, 0.974)],
        ):
        ...
        for actual_aspect_ratio, expected_aspect_ratio in zip(
            list(anchor_generator_object._aspect_ratios), [(1.0, 2.0, 0.5)] + 5 * [(1.0, 1.0)]
        ):
    ...
    """
        ...
        for actual_scales, expected_scales in zip(
            list(anchor_generator_object._scales),
            [(0.2, 0.264), (0.35, 0.418), (0.499, 0.570), (0.649, 0.721), (0.799, 0.871), (0.949, 0.974)],
        ):
            self.assert_almost_list_equal(expected_scales, actual_scales, delta=1e-2)
