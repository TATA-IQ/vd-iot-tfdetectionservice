...
from object_detection.builders import model_builder, model_builder_test
from object_detection.core import losses
from object_detection.models import center_net_resnet_feature_extractor
from object_detection.protos import center_net_pb2, model_pb2
...
class ModelBuilderTF2Test(model_builder_test.ModelBuilderTest):
    ...
    """
        keypoint_label_map_path = os.path.join(self.get_temp_dir(), "keypoint_label_map")
    ...
    """
        config = text_format.Merge(task_proto_txt, center_net_pb2.CenterNet.KeypointEstimation())
        return config
    ...
    """
        return text_format.Merge(proto_txt, center_net_pb2.CenterNet.ObjectCenterParams())
    ...
    def get_fake_densepose_proto(self):
      ...
      heatmap_bias_init: -2.0
    """
        return text_format.Merge(proto_txt, center_net_pb2.CenterNet.DensePoseEstimation())
    ...
    """
        ...
        config.center_net.object_center_params.CopyFrom(self.get_fake_object_center_proto())
        config.center_net.object_detection_task.CopyFrom(self.get_fake_object_detection_proto())
        config.center_net.keypoint_estimation_task.append(self.get_fake_keypoint_proto())
        config.center_net.keypoint_label_map_path = self.get_fake_label_map_file_path()
        config.center_net.mask_estimation_task.CopyFrom(self.get_fake_mask_proto())
        config.center_net.densepose_estimation_task.CopyFrom(self.get_fake_densepose_proto())
        ...
        self.assertIsInstance(model._center_params.classification_loss, losses.PenaltyReducedLogisticFocalLoss)
        ...
        self.assertIsInstance(model._od_params.localization_loss, losses.L1LocalizationLoss)
        ...
        self.assertEqual(kp_params.keypoint_labels, ["nose", "left_shoulder", "right_shoulder", "hip"])
        ...
        self.assertIsInstance(model._mask_params.classification_loss, losses.WeightedSoftmaxClassificationLoss)
        ...
        self.assertIsInstance(model._densepose_params.classification_loss, losses.WeightedSoftmaxClassificationLoss)
        self.assertIsInstance(model._densepose_params.localization_loss, losses.L1LocalizationLoss)
        ...
        self.assertAlmostEqual(model._densepose_params.heatmap_bias_init, -2.0, places=4)

        # Check feature extractor parameters.
        self.assertIsInstance(
            model._feature_extractor, center_net_resnet_feature_extractor.CenterNetResnetFeatureExtractor
        )
