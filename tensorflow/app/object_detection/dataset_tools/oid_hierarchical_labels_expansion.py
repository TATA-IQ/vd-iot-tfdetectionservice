...
flags.DEFINE_string(
    "input_annotations",
    None,
    "Path to Open Images annotations file(either bounding boxes, segments or image-level labels).",
)
flags.DEFINE_string("output_annotations", None, "Path to the output file.")
flags.DEFINE_integer(
    "annotation_type", None, "Type of the input annotations: 1 - boxes or segments,2 - image-level labels."
)
