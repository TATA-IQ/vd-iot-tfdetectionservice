...
def create_mock_tfrecord():
    ...
    feature_map = {
        ...
        standard_fields.TfExampleFields.image_encoded: dataset_util.bytes_feature(encoded_image),
    }
...
def create_mock_graph():
    ...
    with g.as_default():
        ...
        tf.identity(
            tf.constant([[1.0, 2.0, 3.0]]) * tf.reduce_sum(tf.cast(in_image_tensor, dtype=tf.float32)),
...
class InferDetectionsTests(tf.test.TestCase):
    def test_simple(self):
        ...
        ) = detection_inference.build_inference_graph(image_tensor, get_mock_graph_path())
        ...
        with self.test_session(use_gpu=False) as sess:
            ...
            tf_example = detection_inference.infer_detections_and_add_to_example(
                serialized_example_tensor, detected_boxes_tensor, detected_scores_tensor, detected_labels_tensor, False
            )
        ...
        expected_example.features.feature[standard_fields.TfExampleFields.image_encoded].CopyFrom(
    ...
    def test_discard_image(self):
        ...
        with self.test_session(use_gpu=False) as sess:
            ...
            tf_example = detection_inference.infer_detections_and_add_to_example(
                serialized_example_tensor, detected_boxes_tensor, detected_scores_tensor, detected_labels_tensor, True
            )
