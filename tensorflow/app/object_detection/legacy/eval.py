...
flags.DEFINE_boolean(
    "run_once",
    False,
    "Option to only run a single pass of evaluation. Overrides the `max_evals` parameter in the provided config.",
)
FLAGS = flags.FLAGS
...
def main(unused_argv):
    ...
    if "graph_rewriter_config" in configs:
        graph_rewriter_fn = graph_rewriter_builder.build(configs["graph_rewriter_config"], is_training=False)
