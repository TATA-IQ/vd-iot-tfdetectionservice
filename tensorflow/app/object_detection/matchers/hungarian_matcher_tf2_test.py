...
if tf_version.is_tf2():
    from object_detection.matchers import \
        hungarian_matcher  # pylint: disable=g-import-not-at-top
...
class HungarianBipartiteMatcherTest(test_case.TestCase):
    def test_get_expected_matches_when_all_rows_are_valid(self):
        similarity_matrix = np.array([[0.50, 0.1, 0.8], [0.15, 0.2, 0.3]], dtype=np.float32)
    ...
    def test_get_expected_matches_with_only_one_valid_row_at_bottom(self):
        similarity_matrix = np.array([[0.15, 0.2, 0.3], [0.50, 0.1, 0.8]], dtype=np.float32)
    ...
    def test_get_expected_matches_with_two_valid_rows(self):
        similarity_matrix = np.array([[0.15, 0.2, 0.3], [0.50, 0.1, 0.8], [0.84, 0.32, 0.2]], dtype=np.float32)
