...
class ContextProjection(tf.keras.layers.Layer):
    ...
    def __init__(self, projection_dimension, **kwargs):
        ...
        self.projection = tf.keras.layers.Dense(units=projection_dimension, use_bias=True)
    ...
    def call(self, input_features, is_training=False):
        return tf.nn.relu6(self.batch_norm(self.projection(input_features), is_training))
...
class AttentionBlock(tf.keras.layers.Layer):
    ...
    def call(self, box_features, context_features, valid_context_size):
        ...
        output_features = project_features(
            features, self._output_dimension, self._is_training, self._feature_proj, normalize=False
        )
