...
class CalibrationDetectionEvaluationTest(tf.test.TestCase):
    ...
    def testGetECEWithMatchingGroundtruthAndDetections(self):
        ...
        base_eval_dict = {
            ...
            input_data_fields.groundtruth_classes: tf.constant([[1], [2], [3]], dtype=tf.int64),
            ...
            detection_fields.detection_scores: tf.constant([[1.0], [0.0], [1.0]], dtype=tf.float32),
        }
        ...
        zero_ece_op, zero_ece_update_op = calibration_evaluator.get_estimator_eval_metric_ops(zero_ece_eval_dict)[
        ...
        one_ece_op, one_ece_update_op = calibration_evaluator.get_estimator_eval_metric_ops(one_ece_eval_dict)[
            "CalibrationError/ExpectedCalibrationError"
        ]
    ...
    def testGetECEWithUnmatchedGroundtruthAndDetections(self):
        ...
        eval_dict = {
            ...
            detection_fields.detection_boxes: tf.constant(
                [[[50.0, 50.0, 100.0, 100.0]], [[25.0, 25.0, 50.0, 50.0]], [[100.0, 100.0, 200.0, 200.0]]],
                dtype=tf.float32,
            ),
            input_data_fields.groundtruth_classes: tf.constant([[1], [2], [3]], dtype=tf.int64),
            ...
            detection_fields.detection_scores: tf.constant([[0.0], [0.0], [0.0]], dtype=tf.float32),
        }

        ece_op, update_op = calibration_evaluator.get_estimator_eval_metric_ops(eval_dict)[
            "CalibrationError/ExpectedCalibrationError"
        ]
    ...
    def testGetECEWithBatchedDetections(self):
        ...
        eval_dict = {
            ...
            input_data_fields.groundtruth_classes: tf.constant([[1, 2], [2, 3], [3, 1]], dtype=tf.int64),
            detection_fields.detection_classes: tf.constant([[1, 2], [1, 1], [3, 1]], dtype=tf.int64),
            detection_fields.detection_scores: tf.constant([[1.0, 1.0], [0.0, 0.0], [1.0, 1.0]], dtype=tf.float32),
        }
    ...
    def testGetECEWhenImagesFilteredByIsAnnotated(self):
        ...
        eval_dict = {
            ...
            input_data_fields.groundtruth_classes: tf.constant([[1], [2], [1]], dtype=tf.int64),
            detection_fields.detection_classes: tf.constant([[1], [1], [3]], dtype=tf.int64),
            detection_fields.detection_scores: tf.constant([[1.0], [0.0], [1.0]], dtype=tf.float32),
