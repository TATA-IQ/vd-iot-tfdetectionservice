...
class OfflineEvalMapCorlocTest(tf.test.TestCase):
    def test_generateShardedFilenames(self):
        ...
        self.assertEqual(
            result,
            ["/path/to/-00000-of-00003.record", "/path/to/-00001-of-00003.record", "/path/to/-00002-of-00003.record"],
        )

        result = offline_eval._generate_sharded_filenames("/path/to/abc@3")
        self.assertEqual(
            result, ["/path/to/abc-00000-of-00003", "/path/to/abc-00001-of-00003", "/path/to/abc-00002-of-00003"]
        )
