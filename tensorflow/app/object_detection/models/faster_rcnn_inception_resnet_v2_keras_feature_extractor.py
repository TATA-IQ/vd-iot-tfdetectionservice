...
from object_detection.utils import model_util, variables_helper
...
class FasterRCNNInceptionResnetV2KerasFeatureExtractor(faster_rcnn_meta_arch.FasterRCNNKerasFeatureExtractor):
    ...
    def get_proposal_feature_extractor_model(self, name=None):
        ...
        with tf.name_scope(name):
            with tf.name_scope("InceptionResnetV2"):
                proposal_features = self.classification_backbone.get_layer(name="block17_20_ac").output
    ...
    def get_box_classifier_feature_extractor_model(self, name=None):
        ...
        with tf.name_scope(name):
            with tf.name_scope("InceptionResnetV2"):
                proposal_feature_maps = self.classification_backbone.get_layer(name="block17_20_ac").output
                proposal_classifier_features = self.classification_backbone.get_layer(name="conv_7b_ac").output
