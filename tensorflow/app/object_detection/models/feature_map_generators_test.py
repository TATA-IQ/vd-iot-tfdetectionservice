...
class MultiResolutionFeatureMapGeneratorTest(test_case.TestCase):
    ...
    def test_get_expected_feature_map_shapes_with_inception_v2(self):
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_map_generator = self._build_feature_map_generator(feature_map_layout=INCEPTION_V2_LAYOUT)
    ...
    def test_get_expected_feature_map_shapes_with_inception_v2_use_depthwise(self):
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_map_generator = self._build_feature_map_generator(feature_map_layout=layout_copy)
    ...
    def test_feature_map_shapes_with_pool_residual_ssd_mobilenet_v1(self):
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_map_generator = self._build_feature_map_generator(
                feature_map_layout=SSD_MOBILENET_V1_WEIGHT_SHARED_LAYOUT, pool_residual=True
            )
    ...
    def test_get_expected_variable_names_with_inception_v2(self):
        ...
        if tf_version.is_tf2():
            actual_variable_set = set([var.name.split(":")[0] for var in feature_map_generator.variables])
    ...
    def test_get_expected_variable_names_with_inception_v2_use_depthwise(self):
        ...
        expected_keras_variables = set(
            [
                "FeatureMaps/Mixed_5c_1_Conv2d_3_1x1_256_conv/kernel",
                "FeatureMaps/Mixed_5c_1_Conv2d_3_1x1_256_conv/bias",
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_depthwise_conv/depthwise_kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_depthwise_conv/bias",
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_conv/kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_conv/bias",
                "FeatureMaps/Mixed_5c_1_Conv2d_4_1x1_128_conv/kernel",
                "FeatureMaps/Mixed_5c_1_Conv2d_4_1x1_128_conv/bias",
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_depthwise_conv/depthwise_kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_depthwise_conv/bias",
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_conv/kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_conv/bias",
                "FeatureMaps/Mixed_5c_1_Conv2d_5_1x1_128_conv/kernel",
                "FeatureMaps/Mixed_5c_1_Conv2d_5_1x1_128_conv/bias",
                "FeatureMaps/Mixed_5c_2_Conv2d_5_3x3_s2_256_depthwise_conv/depthwise_kernel",
...
@parameterized.parameters({"use_native_resize_op": True}, {"use_native_resize_op": False})
class FPNFeatureMapGeneratorTest(test_case.TestCase, parameterized.TestCase):
    ...
    def test_get_expected_feature_map_shapes(self, use_native_resize_op):
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_map_generator = self._build_feature_map_generator(
                image_features=image_features, depth=128, use_native_resize_op=use_native_resize_op
            )
    ...
    def test_get_expected_feature_map_shapes_with_depthwise(self, use_native_resize_op):
        with test_utils.GraphContextOrNone() as g:
            ...
            feature_map_generator = self._build_feature_map_generator(
                image_features=image_features, depth=128, use_depthwise=True, use_native_resize_op=use_native_resize_op
            )
