...
class InceptionResnetV2Test(test_case.TestCase):
    ...
    def _get_variables(self, layer_names=None):
        tf.keras.backend.clear_session()
        model = self._create_application_with_layer_outputs(layer_names=layer_names, batchnorm_training=False)
    ...
    def test_returns_correct_shapes_128(self):
        ...
        self._check_returns_correct_shape(
            image_height, image_width, expected_feature_map_shape, align_feature_maps=True
        )
    ...
    def test_returns_correct_shapes_128_align_feature_maps_false(self):
        ...
        self._check_returns_correct_shape(
            image_height, image_width, expected_feature_map_shape, align_feature_maps=False
        )
