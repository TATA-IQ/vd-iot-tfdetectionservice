...
from object_detection.models.keras_models import (mobilenet_v1, model_utils,
                                                  test_utils)
...
class MobilenetV1Test(test_case.TestCase):
    ...
    def _check_returns_correct_shape(
        ...
        image_tensor = np.random.rand(_BATCH_SIZE, image_height, image_width, _NUM_CHANNELS).astype(np.float32)
        feature_maps = model(image_tensor)

        for feature_map, expected_shape in zip(feature_maps, expected_feature_map_shape):
    ...
    def test_returns_correct_shapes_128(self):
        ...
        expected_feature_map_shape = test_utils.moblenet_v1_expected_feature_map_shape_128
        self._check_returns_correct_shape(image_height, image_width, depth_multiplier, expected_feature_map_shape)

    def test_returns_correct_shapes_128_explicit_padding(self):
        image_height = 128
        image_width = 128
        depth_multiplier = 1.0
        expected_feature_map_shape = test_utils.moblenet_v1_expected_feature_map_shape_128_explicit_padding
        self._check_returns_correct_shape(
            image_height, image_width, depth_multiplier, expected_feature_map_shape, use_explicit_padding=True
        )
    ...
    def test_returns_correct_shapes_with_dynamic_inputs(self):
        ...
        image_width = 128
        depth_multiplier = 1.0
        expected_feature_map_shape = test_utils.mobilenet_v1_expected_feature_map_shape_with_dynamic_inputs
    ...
    def test_returns_correct_shapes_299(self):
        ...
        image_width = 299
        depth_multiplier = 1.0
        expected_feature_map_shape = test_utils.moblenet_v1_expected_feature_map_shape_299
        self._check_returns_correct_shape(image_height, image_width, depth_multiplier, expected_feature_map_shape)
    ...
    def test_returns_correct_shapes_enforcing_min_depth(self):
        ...
        expected_feature_map_shape = test_utils.moblenet_v1_expected_feature_map_shape_enforcing_min_depth
        self._check_returns_correct_shape(image_height, image_width, depth_multiplier, expected_feature_map_shape)
    ...
    def test_returns_correct_shapes_with_conv_defs(self):
        ...
        expected_feature_map_shape = test_utils.moblenet_v1_expected_feature_map_shape_with_conv_defs
        self._check_returns_correct_shape(
            image_height, image_width, depth_multiplier, expected_feature_map_shape, conv_defs=conv_defs
        )
