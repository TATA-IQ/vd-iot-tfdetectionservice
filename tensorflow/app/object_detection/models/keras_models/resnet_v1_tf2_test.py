...
_RESNET_MODELS = [resnet_v1.resnet_v1_50, resnet_v1.resnet_v1_101, resnet_v1.resnet_v1_152]
_RESNET_SHAPES = [_EXPECTED_SHAPES_224_RESNET50, _EXPECTED_SHAPES_224_RESNET101, _EXPECTED_SHAPES_224_RESNET152]
...
class ResnetV1Test(test_case.TestCase):
    ...
    def _get_variables(self, model_index):
        tf.keras.backend.clear_session()
        model = self._create_application_with_layer_outputs(model_index, batchnorm_training=False)
    ...
    def test_returns_correct_shapes_224(self):
        ...
        for model_index, _ in enumerate(_RESNET_NAMES):
            ...
            self._check_returns_correct_shape(image_height, image_width, model_index, expected_feature_map_shape)
...
class ResnetShapeTest(test_case.TestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        ...
        },
        {
            ...
            "output_layer_names": ["conv2_block2_out", "conv3_block2_out", "conv4_block2_out", "conv5_block2_out"],
        },
    )
