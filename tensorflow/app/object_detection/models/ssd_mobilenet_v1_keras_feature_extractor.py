...
class SSDMobileNetV1KerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    ...
    def __init__(
        ...
        self._feature_map_layout = {
            "from_layer": ["Conv2d_11_pointwise", "Conv2d_13_pointwise", "", "", "", ""][: self._num_layers],
    ...
    def build(self, input_shape):
        ...
        self.classification_backbone = tf.keras.Model(
            inputs=full_mobilenet_v1.inputs, outputs=[conv2d_11_pointwise, conv2d_13_pointwise]
        )
    ...
    def _extract_features(self, preprocessed_inputs):
        ...
        feature_maps = self._feature_map_generator(
            {"Conv2d_11_pointwise": image_features[0], "Conv2d_13_pointwise": image_features[1]}
        )
