...
class SSDMobileNetV2FpnKerasFeatureExtractor(ssd_meta_arch.SSDKerasFeatureExtractor):
    ...
    def build(self, input_shape):
        ...
        self.classification_backbone = tf.keras.Model(inputs=full_mobilenet_v2.inputs, outputs=outputs)
    ...
    def _extract_features(self, preprocessed_inputs):
        ...
        fpn_input_image_features = [
            (key, image_features[feature_start_index + index]) for index, key in enumerate(feature_block_list)
        ]
