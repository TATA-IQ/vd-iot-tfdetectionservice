...
class SsdMobilenetV2MnasFPNFeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
    ...
    def test_extract_features_returns_correct_shapes_320_256(self):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 40, 32, 48), (2, 20, 16, 48), (2, 10, 8, 48), (2, 5, 4, 48)]
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(self):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 32, 32, 16), (2, 16, 16, 16), (2, 8, 8, 16), (2, 4, 4, 16)]
        self.check_extract_features_returns_correct_shape(
            2,
            image_height,
            image_width,
