...
class RfcnBoxPredictor(box_predictor.BoxPredictor):
    ...
    def __init__(
        self, is_training, num_classes, conv_hyperparams_fn, num_spatial_bins, depth, crop_size, box_code_size
    ):
        """Constructor.
    ...
    def _predict(self, image_features, num_predictions_per_location, proposal_boxes):
        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
            ...
            location_feature_map = slim.conv2d(
                net, location_feature_map_depth, [1, 1], activation_fn=None, scope="refined_locations"
            )
            ...
            box_encodings = tf.reshape(
                box_encodings, [batch_size * num_boxes, 1, self.num_classes, self._box_code_size]
            )
            ...
            class_feature_map = slim.conv2d(
                net, class_feature_map_depth, [1, 1], activation_fn=None, scope="class_predictions"
            )
            ...
            class_predictions_with_background = tf.reshape(
                class_predictions_with_background, [batch_size * num_boxes, 1, total_classes]
            )
