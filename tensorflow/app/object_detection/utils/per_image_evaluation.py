...
class PerImageEvaluation(object):
    ...
    def _compute_cor_loc(
        ...
        for i in range(self.num_groundtruth_classes):
            ...
            is_class_correctly_detected_in_image[i] = self._compute_is_class_correctly_detected_in_image(
    ...
    def _compute_is_class_correctly_detected_in_image(
        self, detected_boxes, detected_scores, groundtruth_boxes, detected_masks=None, groundtruth_masks=None
    ):
    ...
    def _compute_tp_fp_for_single_class(
        ...
        if iou_mask.shape[1] > 0:
            ...
            compute_match_iou(
                iou_mask, groundtruth_is_difficult_mask_list[~groundtruth_is_group_of_mask_list], is_box=False
            )
        ...
        if mask_mode:
            ...
            return np.concatenate((scores[valid_entries], scores_mask_group_of)), np.concatenate(
            ...
            return np.concatenate((scores[valid_entries], scores_box_group_of)), np.concatenate(
