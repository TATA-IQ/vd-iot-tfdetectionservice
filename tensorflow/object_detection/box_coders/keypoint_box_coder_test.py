...
class KeypointBoxCoderTest(test_case.TestCase):
    def test_get_correct_relative_codes_after_encoding(self):
        ...
        keypoints = np.array([[[15.0, 12.0], [10.0, 15.0]], [[0.5, 0.3], [0.2, 0.4]]], np.float32)
        ...
        expected_rel_codes = [
            ...
            [-0.083333, -0.222222, -0.693147, -1.098612, 0.166667, -0.166667, -0.333333, -0.055556],
        ]
    ...
    def test_get_correct_relative_codes_after_encoding_with_scaling(self):
        ...
        expected_rel_codes = [
            ...
            [-0.166667, -0.666667, -2.772588, -5.493062, 0.333333, -0.5, -0.666667, -0.166667],
        ]
