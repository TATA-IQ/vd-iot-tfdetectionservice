...
class KerasLayerHyperparams(object):
    ...
    def __init__(self, hyperparams_config):
        ...
        self._op_params = {
            ...
            "kernel_initializer": _build_initializer(hyperparams_config.initializer, build_for_keras=True),
    ...
    def use_bias(self):
        return self._force_use_bias or not (self.use_batch_norm() and self.batch_norm_params()["center"])
...
def build(hyperparams_config, is_training):
    ...
    if hyperparams_config.force_use_bias:
        raise ValueError("Hyperparams force_use_bias only supported by KerasLayerHyperparams.")
        ...
        if build_for_keras:
            if initializer.variance_scaling_initializer.uniform:
                return tf.variance_scaling_initializer(
                    scale=initializer.variance_scaling_initializer.factor, mode=mode.lower(), distribution="uniform"
                )
            else:
