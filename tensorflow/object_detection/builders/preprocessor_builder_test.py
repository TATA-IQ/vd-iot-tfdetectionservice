...
class PreprocessorBuilderTest(tf.test.TestCase):
    ...
    """
        ...
        self.assertEqual(args, {"keypoint_flip_permutation": (1, 0, 2, 3, 5, 4), "probability": 0.5})
    ...
    """
        ...
        self.assertEqual(args, {"keypoint_rot_permutation": (3, 0, 1, 2), "probability": 0.5})
    ...
    """
        ...
        self.assertEqual(args, {"scale_min": 0.25, "scale_max": 2.0, "num_scales": 8, "max_border": 128})
