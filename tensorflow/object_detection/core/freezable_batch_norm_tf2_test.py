...
class FreezableBatchNormTest(tf.test.TestCase):
    ...
    def _test_batchnorm_layer(
        self, norm, should_be_training, test_data, testing_mean, testing_var, training_arg, training_mean, training_var
    ):
    ...
    def test_batchnorm_freezing_training_none(self):
        ...
        self._test_batchnorm_layer(
            norm, should_be_training, test_data, testing_mean, testing_var, training_arg, training_mean, training_var
        )
