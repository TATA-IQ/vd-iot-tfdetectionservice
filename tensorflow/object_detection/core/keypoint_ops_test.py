...
class KeypointOpsTest(test_case.TestCase):
    ...
    def test_keypoint_weights_from_visibilities_no_per_kpt_weights(self):
        def graph_fn():
            keypoint_visibilities = tf.constant([[True, True, False], [False, True, False]])
            keypoint_weights = keypoint_ops.keypoint_weights_from_visibilities(keypoint_visibilities)
            return keypoint_weights
    ...
    def test_set_keypoint_visibilities(self):
        ...
        def graph_fn():
            keypoints = tf.constant(keypoints_np, dtype=tf.float32)
            initial_keypoint_visibilities = tf.constant(initial_keypoint_visibilities_np, dtype=tf.bool)
            keypoint_visibilities = keypoint_ops.set_keypoint_visibilities(keypoints, initial_keypoint_visibilities)
            return keypoint_visibilities
