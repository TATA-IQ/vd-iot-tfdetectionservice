...
class DetectionModel(six.with_metaclass(abc.ABCMeta, _BaseClass)):
    ...
    def provide_groundtruth(
        ...
        if groundtruth_keypoint_visibilities_list:
            self._groundtruth_lists[fields.BoxListFields.keypoint_visibilities] = groundtruth_keypoint_visibilities_list
        if groundtruth_dp_num_points_list:
            self._groundtruth_lists[fields.BoxListFields.densepose_num_points] = groundtruth_dp_num_points_list
        if groundtruth_dp_part_ids_list:
            self._groundtruth_lists[fields.BoxListFields.densepose_part_ids] = groundtruth_dp_part_ids_list
        if groundtruth_dp_surface_coords_list:
            self._groundtruth_lists[fields.BoxListFields.densepose_surface_coords] = groundtruth_dp_surface_coords_list
        if groundtruth_track_ids_list:
            self._groundtruth_lists[fields.BoxListFields.track_ids] = groundtruth_track_ids_list
        if groundtruth_temporal_offsets_list:
            self._groundtruth_lists[fields.BoxListFields.temporal_offsets] = groundtruth_temporal_offsets_list
        if groundtruth_track_match_flags_list:
            self._groundtruth_lists[fields.BoxListFields.track_match_flags] = groundtruth_track_match_flags_list
        ...
        if groundtruth_labeled_classes:
            self._groundtruth_lists[fields.InputDataFields.groundtruth_labeled_classes] = groundtruth_labeled_classes
