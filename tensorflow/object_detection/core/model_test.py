...
class ModelTest(test_case.TestCase):
    ...
    def test_freeze(self):
        ...
        net1_var_shapes = [tuple(var.get_shape().as_list()) for var in detection_model._network1.trainable_variables]
        ...
        var_shapes = [tuple(var.get_shape().as_list()) for var in detection_model._network1.trainable_variables]
