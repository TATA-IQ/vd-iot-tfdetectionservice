    ...
    example = tf.train.Example(
        features=tf.train.Features(
            feature={
                ...
                "image/object/truncated": dataset_util.float_list_feature(annotations["truncated"]),
                "image/object/alpha": dataset_util.float_list_feature(annotations["alpha"]),
                "image/object/3d_bbox/height": dataset_util.float_list_feature(annotations["3d_bbox_height"]),
                "image/object/3d_bbox/width": dataset_util.float_list_feature(annotations["3d_bbox_width"]),
                "image/object/3d_bbox/length": dataset_util.float_list_feature(annotations["3d_bbox_length"]),
                "image/object/3d_bbox/x": dataset_util.float_list_feature(annotations["3d_bbox_x"]),
                "image/object/3d_bbox/y": dataset_util.float_list_feature(annotations["3d_bbox_y"]),
                "image/object/3d_bbox/z": dataset_util.float_list_feature(annotations["3d_bbox_z"]),
                "image/object/3d_bbox/rot_y": dataset_util.float_list_feature(annotations["3d_bbox_rot_y"]),
            }
        )
    )
