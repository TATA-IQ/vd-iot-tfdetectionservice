...
class CreateKittiTFRecordTest(tf.test.TestCase):
    ...
    def test_dict_to_tf_example(self):
        ...
        self._assertProtoEqual(example.features.feature["image/filename"].bytes_list.value, [six.b(save_path)])
        self._assertProtoEqual(example.features.feature["image/source_id"].bytes_list.value, [six.b(save_path)])
        self._assertProtoEqual(example.features.feature["image/format"].bytes_list.value, [six.b("png")])
        ...
        self._assertProtoEqual(example.features.feature["image/object/class/text"].bytes_list.value, [six.b("car")])
