...
class CreatePascalTFRecordTest(tf.test.TestCase):
    ...
    def test_dict_to_tf_example(self):
        ...
        self._assertProtoEqual(example.features.feature["image/source_id"].bytes_list.value, [six.b(image_file_name)])
        ...
        self._assertProtoEqual(example.features.feature["image/object/view"].bytes_list.value, [six.b("")])
