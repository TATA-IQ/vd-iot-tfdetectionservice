...
flags.DEFINE_string(
    "mask_type", "png", 'How to represent instance segmentation masks. Options are "png" or "numerical".'
)
        ...
        for idx, example in enumerate(examples):
            ...
            try:
                tf_example = dict_to_tf_example(
                    data, mask_path, label_map_dict, image_dir, faces_only=faces_only, mask_type=mask_type
                )
                if tf_example:
