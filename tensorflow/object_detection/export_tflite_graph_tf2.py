...
# SSD-specific flags
flags.DEFINE_integer("ssd_max_detections", 10, "Maximum number of detections (boxes) to return.")
flags.DEFINE_bool(
    "ssd_use_regular_nms",
    False,
    "Flag to set postprocessing op to use Regular NMS instead of Fast NMS (Default false).",
)
