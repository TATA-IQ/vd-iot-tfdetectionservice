...
from object_detection.protos import calibration_pb2, model_pb2
from object_detection.utils import ops, test_case, test_utils, tf_version
...
class FakeSSDFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
    ...
    def __init__(self):
        super(FakeSSDFeatureExtractor, self).__init__(
            is_training=True, depth_multiplier=0, min_depth=0, pad_to_multiple=1, conv_hyperparams_fn=None
        )
    ...
    def _create_model(
      ...
      function_approximation {
        ...
        target_assigner_instance = target_assigner.TargetAssigner(
            region_similarity_calculator, mock_matcher, mock_box_coder, negative_class_weight=negative_class_weight
        )
