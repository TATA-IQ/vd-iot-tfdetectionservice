...
class CenterNetResnetFeatureExtractorTest(test_case.TestCase):
    def test_output_size(self):
        ...
        model = center_net_resnet_feature_extractor.CenterNetResnetFeatureExtractor("resnet_v2_101")
    ...
    def test_output_size_resnet50(self):
        ...
        model = center_net_resnet_feature_extractor.CenterNetResnetFeatureExtractor("resnet_v2_50")
