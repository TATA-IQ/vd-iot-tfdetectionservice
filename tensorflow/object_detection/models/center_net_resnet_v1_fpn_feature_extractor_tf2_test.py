...
class CenterNetResnetV1FpnFeatureExtractorTest(test_case.TestCase, parameterized.TestCase):
    ...
    def test_correct_output_size(self, resnet_type):
        ...
        model = center_net_resnet_v1_fpn_feature_extractor.CenterNetResnetV1FpnFeatureExtractor(resnet_type)
