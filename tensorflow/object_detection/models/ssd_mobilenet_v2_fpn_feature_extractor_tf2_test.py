...
from object_detection.models import (
    ssd_feature_extractor_test, ssd_mobilenet_v2_fpn_keras_feature_extractor)
...
class SsdMobilenetV2FpnFeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
    ...
    def test_extract_features_returns_correct_shapes_with_pad_to_multiple(self, use_depthwise):
        use_keras = True
        image_height = 299
        image_width = 299
        depth_multiplier = 1.0
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(self, use_depthwise):
        use_keras = True
        image_height = 256
        image_width = 256
    ...
    def test_extract_features_raises_error_with_invalid_image_size(self, use_depthwise=False):
        use_keras = True
        image_height = 32
        image_width = 32
        depth_multiplier = 1.0
