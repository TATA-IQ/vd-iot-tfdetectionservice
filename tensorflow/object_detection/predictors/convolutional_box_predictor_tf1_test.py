...
from object_detection.predictors.heads import box_head, class_head, mask_head
...
class WeightSharedConvolutionalBoxPredictorTest(test_case.TestCase):
    ...
    def test_get_boxes_for_five_aspect_ratios_per_location(self):
        def graph_fn(image_features):
            conv_box_predictor = box_predictor_builder.build_weight_shared_convolutional_box_predictor(
                is_training=False,
                num_classes=0,
                conv_hyperparams_fn=self._build_arg_scope_with_conv_hyperparams(),
                depth=32,
    ...
    def test_get_multi_class_predictions_from_two_feature_maps(self):
        ...
        def graph_fn(image_features1, image_features2):
            ...
            box_predictions = conv_box_predictor.predict(
                [image_features1, image_features2], num_predictions_per_location=[5, 5], scope="BoxPredictor"
            )
            box_encodings = tf.concat(box_predictions[box_predictor.BOX_ENCODINGS], axis=1)
            class_predictions_with_background = tf.concat(
                box_predictions[box_predictor.CLASS_PREDICTIONS_WITH_BACKGROUND], axis=1
    ...
    def test_predictions_multiple_feature_maps_share_weights_separate_batchnorm(self):
        ...
        with self.test_session(graph=tf.Graph()):
            graph_fn(
                tf.random_uniform([4, 32, 32, 3], dtype=tf.float32), tf.random_uniform([4, 16, 16, 3], dtype=tf.float32)
            )
            actual_variable_set = set([var.op.name for var in tf.trainable_variables()])
        expected_variable_set = set(
            [
                # Box prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/weights",
                (
                ...
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/weights",
                (
                    "BoxPredictor/WeightSharedConvolutionalBoxPredictor/"
                ...
                # Box prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/biases",
                # Class prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/weights",
                (
                    "BoxPredictor/WeightSharedConvolutionalBoxPredictor/"
                ...
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/weights",
                (
                    "BoxPredictor/WeightSharedConvolutionalBoxPredictor/"
                ...
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/biases",
            ]
        )
        self.assertEqual(expected_variable_set, actual_variable_set)
    ...
    def test_predictions_multiple_feature_maps_share_weights_without_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                # Box prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/biases",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/biases",
                # Box prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/biases",
                # Class prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/biases",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/biases",
                # Class prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/biases",
            ]
    ...
    def test_predictions_multiple_feature_maps_share_weights_with_depthwise(self):
        ...
        expected_variable_set = set(
            [
                # Box prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/biases",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/biases",
                # Box prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/biases",
                # Class prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/biases",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/biases",
                # Class prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/depthwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/pointwise_weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/ClassPredictor/biases",
            ]
        )
        self.assertEqual(expected_variable_set, actual_variable_set)
    ...
    def test_predictions_share_weights_share_tower_separate_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                ...
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_0/beta",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_1/beta",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_0/beta",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_1/beta",
                # Box prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/biases",
                # Class prediction head
    ...
    def test_predictions_share_weights_share_tower_without_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                # Shared prediction tower
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/biases",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/biases",
                # Box prediction head
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/weights",
                "BoxPredictor/WeightSharedConvolutionalBoxPredictor/BoxPredictor/biases",
                # Class prediction head
        ...
        def graph_fn(image_features):
            ...
            other_heads = {
                other_head_name: mask_head.WeightSharedConvolutionalMaskHead(
                    num_classes_without_background, mask_height=mask_height, mask_width=mask_width
                )
            }
            ...
            box_predictions = conv_box_predictor.predict(
                [image_features], num_predictions_per_location=[num_predictions_per_location], scope="BoxPredictor"
            )
