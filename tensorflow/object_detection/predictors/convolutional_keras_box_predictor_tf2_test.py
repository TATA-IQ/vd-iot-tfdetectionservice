...
class ConvolutionalKerasBoxPredictorTest(test_case.TestCase):
    ...
    def test_get_boxes_for_five_aspect_ratios_per_location(self):
        conv_box_predictor = box_predictor_builder.build_convolutional_keras_box_predictor(
            is_training=False,
            num_classes=0,
    ...
    def test_get_predictions_with_feature_maps_of_dynamic_shape(self):
        ...
        box_encodings, objectness_predictions = self.execute(graph_fn, [np.random.rand(4, resolution, resolution, 64)])
    ...
    def test_use_depthwise_convolution(self):
        ...
        expected_variable_set = set(
            [
                "BoxPredictor/SharedConvolutions_0/Conv2d_0_1x1_32/bias",
                "BoxPredictor/SharedConvolutions_0/Conv2d_0_1x1_32/kernel",
                "BoxPredictor/ConvolutionalBoxHead_0/BoxEncodingPredictor_depthwise/bias",
                "BoxPredictor/ConvolutionalBoxHead_0/BoxEncodingPredictor_depthwise/depthwise_kernel",
                "BoxPredictor/ConvolutionalBoxHead_0/BoxEncodingPredictor/bias",
                "BoxPredictor/ConvolutionalBoxHead_0/BoxEncodingPredictor/kernel",
                "BoxPredictor/ConvolutionalClassHead_0/ClassPredictor_depthwise/bias",
                "BoxPredictor/ConvolutionalClassHead_0/ClassPredictor_depthwise/depthwise_kernel",
                "BoxPredictor/ConvolutionalClassHead_0/ClassPredictor/bias",
                "BoxPredictor/ConvolutionalClassHead_0/ClassPredictor/kernel",
            ]
        )
...
class WeightSharedConvolutionalKerasBoxPredictorTest(test_case.TestCase):
    ...
    def test_predictions_multiple_feature_maps_share_weights_separate_batchnorm(self):
        ...
        self.execute(
            graph_fn, [np.random.rand(4, 32, 32, 3).astype(np.float32), np.random.rand(4, 16, 16, 3).astype(np.float32)]
        )
        actual_variable_set = set([var.name.split(":")[0] for var in variables])
        expected_variable_set = set(
            [
                # Box prediction tower
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_0/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_0/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_1/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/BatchNorm/feature_1/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_0/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_0/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_1/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/BatchNorm/feature_1/moving_variance",
                # Box prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/bias",
                # Class prediction tower
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/BatchNorm/feature_0/moving_mean",
                (
                    "WeightSharedConvolutionalBoxPredictor/"
                    "ClassPredictionTower/conv2d_0/BatchNorm/feature_0/moving_variance"
                ),
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/BatchNorm/feature_1/moving_mean",
                (
                    "WeightSharedConvolutionalBoxPredictor/"
                    "ClassPredictionTower/conv2d_0/BatchNorm/feature_1/moving_variance"
                ),
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/BatchNorm/feature_0/moving_mean",
                (
                    "WeightSharedConvolutionalBoxPredictor/"
                    "ClassPredictionTower/conv2d_1/BatchNorm/feature_0/moving_variance"
                ),
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/BatchNorm/feature_1/moving_mean",
                (
                    "WeightSharedConvolutionalBoxPredictor/"
    ...
    def test_predictions_multiple_feature_maps_share_weights_without_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                # Box prediction tower
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/bias",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/bias",
                # Box prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/bias",
                # Class prediction tower
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/bias",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/bias",
                # Class prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalClassHead/ClassPredictor/kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalClassHead/ClassPredictor/bias",
            ]
    ...
    def test_predictions_multiple_feature_maps_share_weights_with_depthwise(self):
        ...
        expected_variable_set = set(
            [
                # Box prediction tower
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/depthwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/pointwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_0/bias",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/depthwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/pointwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/BoxPredictionTower/conv2d_1/bias",
                # Box prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/depthwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/pointwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/bias",
                # Class prediction tower
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/depthwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/pointwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_0/bias",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/depthwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/pointwise_kernel",
                "WeightSharedConvolutionalBoxPredictor/ClassPredictionTower/conv2d_1/bias",
                # Class prediction head
                (
                    "WeightSharedConvolutionalBoxPredictor/"
    ...
    def test_predictions_share_weights_share_tower_separate_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                ...
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_0/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_1/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_0/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/BatchNorm/feature_1/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_0/beta",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_1/beta",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_0/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_1/moving_mean",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_0/moving_variance",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/BatchNorm/feature_1/moving_variance",
                # Box prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/bias",
                # Class prediction head
    ...
    def test_predictions_share_weights_share_tower_without_batchnorm(self):
        ...
        expected_variable_set = set(
            [
                # Shared prediction tower
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/kernel",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_0/bias",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/kernel",
                "WeightSharedConvolutionalBoxPredictor/PredictionTower/conv2d_1/bias",
                # Box prediction head
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/kernel",
                "WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalBoxHead/BoxPredictor/bias",
                # Class prediction head
    ...
    def test_other_heads_predictions(self):
        ...
        self.assertAllEqual(
            ...
            [batch_size, num_anchors, num_classes_without_background, mask_height, mask_width],
        )
