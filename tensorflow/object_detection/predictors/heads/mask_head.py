    ...
    def predict(self, features, num_predictions_per_location=1):
        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
            ...
            mask_predictions = slim.conv2d(
                features, num_outputs=num_masks, activation_fn=None, normalizer_fn=None, kernel_size=[3, 3]
            )
...
class ConvolutionalMaskHead(head.Head):
    ...
    def predict(self, features, num_predictions_per_location):
        ...
        mask_predictions = tf.reshape(
            mask_predictions, [batch_size, -1, num_masks, self._mask_height, self._mask_width]
        )
