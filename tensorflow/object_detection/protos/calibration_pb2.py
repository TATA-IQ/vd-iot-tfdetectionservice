...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        b'\n)object_detection/protos/calibration.proto\x12\x17object_detection.protos"\xe4\x03\n\x11\x43\x61librationConfig\x12P\n\x16\x66unction_approximation\x18\x01'
        b" \x01(\x0b\x32..object_detection.protos.FunctionApproximationH\x00\x12\x62\n"
        b" class_id_function_approximations\x18\x02"
        b" \x01(\x0b\x32\x36.object_detection.protos.ClassIdFunctionApproximationsH\x00\x12J\n\x13sigmoid_calibration\x18\x03"
        b" \x01(\x0b\x32+.object_detection.protos.SigmoidCalibrationH\x00\x12\\\n\x1d\x63lass_id_sigmoid_calibrations\x18\x04"
        b" \x01(\x0b\x32\x33.object_detection.protos.ClassIdSigmoidCalibrationsH\x00\x12\x61\n\x1ftemperature_scaling_calibration\x18\x05"
        b' \x01(\x0b\x32\x36.object_detection.protos.TemperatureScalingCalibrationH\x00\x42\x0c\n\ncalibrator"L\n\x15\x46unctionApproximation\x12\x33\n\tx_y_pairs\x18\x01'
        b" \x01(\x0b\x32"
        b' .object_detection.protos.XYPairs"\xe9\x01\n\x1d\x43lassIdFunctionApproximations\x12l\n\x15\x63lass_id_xy_pairs_map\x18\x01'
        b" \x03(\x0b\x32M.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry\x1aZ\n\x16\x43lassIdXyPairsMapEntry\x12\x0b\n\x03key\x18\x01"
        b" \x01(\x05\x12/\n\x05value\x18\x02 \x01(\x0b\x32"
        b' .object_detection.protos.XYPairs:\x02\x38\x01"\\\n\x12SigmoidCalibration\x12\x46\n\x12sigmoid_parameters\x18\x01'
        b' \x01(\x0b\x32*.object_detection.protos.SigmoidParameters"\x8b\x02\n\x1a\x43lassIdSigmoidCalibrations\x12}\n\x1f\x63lass_id_sigmoid_parameters_map\x18\x01'
        b" \x03(\x0b\x32T.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry\x1an\n"
        b" ClassIdSigmoidParametersMapEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12\x39\n\x05value\x18\x02"
        b' \x01(\x0b\x32*.object_detection.protos.SigmoidParameters:\x02\x38\x01"/\n\x1dTemperatureScalingCalibration\x12\x0e\n\x06scaler\x18\x01'
        b' \x01(\x02"\xab\x01\n\x07XYPairs\x12\x39\n\x08x_y_pair\x18\x01'
        b" \x03(\x0b\x32'.object_detection.protos.XYPairs.XYPair\x12\x45\n\x12training_data_type\x18\x02"
        b" \x01(\x0e\x32).object_detection.protos.TrainingDataType\x1a\x1e\n\x06XYPair\x12\t\n\x01x\x18\x01"
        b' \x01(\x02\x12\t\n\x01y\x18\x02 \x01(\x02"0\n\x11SigmoidParameters\x12\r\n\x01\x61\x18\x01'
        b" \x01(\x02:\x02-1\x12\x0c\n\x01\x62\x18\x02"
...
_CALIBRATIONCONFIG.fields_by_name["function_approximation"].containing_oneof = _CALIBRATIONCONFIG.oneofs_by_name[
    "calibrator"
]
_CALIBRATIONCONFIG.oneofs_by_name["calibrator"].fields.append(
...
_CALIBRATIONCONFIG.fields_by_name["sigmoid_calibration"].containing_oneof = _CALIBRATIONCONFIG.oneofs_by_name[
    "calibrator"
]
_CALIBRATIONCONFIG.oneofs_by_name["calibrator"].fields.append(
    _CALIBRATIONCONFIG.fields_by_name["class_id_sigmoid_calibrations"]
)
_CALIBRATIONCONFIG.fields_by_name["class_id_sigmoid_calibrations"].containing_oneof = _CALIBRATIONCONFIG.oneofs_by_name[
    "calibrator"
]
_CALIBRATIONCONFIG.oneofs_by_name["calibrator"].fields.append(
