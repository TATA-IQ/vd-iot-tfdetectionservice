...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        ...
        b" \x01(\r:\x01\x31\x12\x1e\n\x12num_visualizations\x18\x01"
        b" \x01(\r:\x02\x31\x30\x12\x1e\n\x0cnum_examples\x18\x02"
        b" \x01(\r:\x04\x35\x30\x30\x30\x42\x02\x18\x01\x12\x1f\n\x12\x65val_interval_secs\x18\x03"
        b" \x01(\r:\x03\x33\x30\x30\x12\x18\n\tmax_evals\x18\x04"
        b" \x01(\r:\x01\x30\x42\x02\x18\x01\x12\x19\n\nsave_graph\x18\x05"
        b' \x01(\x08:\x05\x66\x61lse\x12"\n\x18visualization_export_dir\x18\x06'
        b" \x01(\t:\x00\x12\x15\n\x0b\x65val_master\x18\x07 \x01(\t:\x00\x12\x13\n\x0bmetrics_set\x18\x08"
        b" \x03(\t\x12J\n\x14parameterized_metric\x18\x1f"
        b" \x03(\x0b\x32,.object_detection.protos.ParameterizedMetric\x12\x15\n\x0b\x65xport_path\x18\t"
        b" \x01(\t:\x00\x12!\n\x12ignore_groundtruth\x18\n"
        b' \x01(\x08:\x05\x66\x61lse\x12"\n\x13use_moving_averages\x18\x0b'
        b' \x01(\x08:\x05\x66\x61lse\x12"\n\x13\x65val_instance_masks\x18\x0c \x01(\x08:\x05\x66\x61lse\x12'
        b" \n\x13min_score_threshold\x18\r \x01(\x02:\x03\x30.5\x12&\n\x1amax_num_boxes_to_visualize\x18\x0e"
        b" \x01(\x05:\x02\x32\x30\x12\x1a\n\x0bskip_scores\x18\x0f"
        b" \x01(\x08:\x05\x66\x61lse\x12\x1a\n\x0bskip_labels\x18\x10"
        b" \x01(\x08:\x05\x66\x61lse\x12*\n\x1bvisualize_groundtruth_boxes\x18\x11"
        b" \x01(\x08:\x05\x66\x61lse\x12\x32\n#groundtruth_box_visualization_color\x18\x12"
        b" \x01(\t:\x05\x62lack\x12\x35\n&keep_image_id_for_visualization_export\x18\x13"
        b" \x01(\x08:\x05\x66\x61lse\x12$\n\x16retain_original_images\x18\x17"
        b" \x01(\x08:\x04true\x12+\n\x1cinclude_metrics_per_category\x18\x18"
        b' \x01(\x08:\x05\x66\x61lse\x12R\n\x10super_categories\x18"'
        b" \x03(\x0b\x32\x38.object_detection.protos.EvalConfig.SuperCategoriesEntry\x12\x1d\n\x12recall_lower_bound\x18\x1a"
        b" \x01(\x02:\x01\x30\x12\x1d\n\x12recall_upper_bound\x18\x1b"
        b" \x01(\x02:\x01\x31\x12\x38\n)retain_original_image_additional_channels\x18\x1c"
        b" \x01(\x08:\x05\x66\x61lse\x12\x1e\n\x0f\x66orce_no_resize\x18\x1d"
        b" \x01(\x08:\x05\x66\x61lse\x12%\n\x16use_dummy_loss_in_eval\x18\x1e"
        b" \x01(\x08:\x05\x66\x61lse\x12<\n\rkeypoint_edge\x18 "
        b" \x03(\x0b\x32%.object_detection.protos.KeypointEdge\x12\x33\n$skip_predictions_for_unlabeled_class\x18!"
        b" \x01(\x08:\x05\x66\x61lse\x1a\x36\n\x14SuperCategoriesEntry\x12\x0b\n\x03key\x18\x01"
        b" \x01(\t\x12\r\n\x05value\x18\x02"
        b' \x01(\t:\x02\x38\x01"|\n\x13ParameterizedMetric\x12M\n\x15\x63oco_keypoint_metrics\x18\x01'
        b' \x01(\x0b\x32,.object_detection.protos.CocoKeypointMetricsH\x00\x42\x16\n\x14parameterized_metric"\xd3\x01\n\x13\x43ocoKeypointMetrics\x12\x13\n\x0b\x63lass_label\x18\x01'
        b" \x01(\t\x12i\n\x18keypoint_label_to_sigmas\x18\x02"
        b" \x03(\x0b\x32G.object_detection.protos.CocoKeypointMetrics.KeypointLabelToSigmasEntry\x1a<\n\x1aKeypointLabelToSigmasEntry\x12\x0b\n\x03key\x18\x01"
...
_EVALCONFIG_SUPERCATEGORIESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="object_detection.protos.EvalConfig.SuperCategoriesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="object_detection.protos.EvalConfig.SuperCategoriesEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_EVALCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="object_detection.protos.EvalConfig.super_categories",
            index=23,
            number=34,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="skip_predictions_for_unlabeled_class",
            full_name="object_detection.protos.EvalConfig.skip_predictions_for_unlabeled_class",
            index=30,
            number=33,
            type=8,
            cpp_type=7,
    ...
    extensions=[],
    nested_types=[
        _EVALCONFIG_SUPERCATEGORIESENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_PARAMETERIZEDMETRIC.fields_by_name["coco_keypoint_metrics"].containing_oneof = _PARAMETERIZEDMETRIC.oneofs_by_name[
    "parameterized_metric"
]
_COCOKEYPOINTMETRICS_KEYPOINTLABELTOSIGMASENTRY.containing_type = _COCOKEYPOINTMETRICS
_COCOKEYPOINTMETRICS.fields_by_name[
...
EvalConfig = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "SuperCategoriesEntry": _reflection.GeneratedProtocolMessageType(
            "SuperCategoriesEntry",
            (_message.Message,),
            {
...
CocoKeypointMetrics = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "KeypointLabelToSigmasEntry": _reflection.GeneratedProtocolMessageType(
