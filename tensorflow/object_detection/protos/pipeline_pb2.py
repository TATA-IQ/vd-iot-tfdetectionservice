...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        ...
        b" \x01(\x0b\x32'.object_detection.protos.DetectionModel\x12:\n\x0ctrain_config\x18\x02"
        b" \x01(\x0b\x32$.object_detection.protos.TrainConfig\x12@\n\x12train_input_reader\x18\x03"
        b" \x01(\x0b\x32$.object_detection.protos.InputReader\x12\x38\n\x0b\x65val_config\x18\x04"
        b" \x01(\x0b\x32#.object_detection.protos.EvalConfig\x12?\n\x11\x65val_input_reader\x18\x05"
        b" \x03(\x0b\x32$.object_detection.protos.InputReader\x12>\n\x0egraph_rewriter\x18\x06"
        b" \x01(\x0b\x32&.object_detection.protos.GraphRewriter*\t\x08\xe8\x07\x10\x80\x80\x80\x80\x02"
    ),
    dependencies=[
