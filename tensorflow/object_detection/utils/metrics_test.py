...
class MetricsTest(tf.test.TestCase):
    ...
    def test_compute_precision_recall(self):
        ...
        precision_float_type, recall_float_type = metrics.compute_precision_recall(scores, labels_float_type, num_gt)
    ...
    def test_compute_precision_recall_float(self):
        ...
        expected_precision = np.array([0.0, 0.5, 0.33333333, 0.5, 0.55555556, 0.63636364], dtype=float)
