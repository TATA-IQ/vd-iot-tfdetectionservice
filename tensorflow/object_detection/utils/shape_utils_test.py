...
class AssertShapeEqualTest(test_case.TestCase):
    ...
    def test_unequal_dynamic_shape_raises_tf_assert(self):
        ...
        self.assertRaises(ValueError, self.execute, graph_fn, [np.zeros([1, 2, 2, 3]), np.zeros([1, 4, 4, 3])])
    ...
    def test_unequal_dynamic_shape_along_first_dim_raises_tf_assert(self):
        ...
        self.assertRaises(ValueError, self.execute, graph_fn, [np.zeros([1, 2, 2, 3]), np.zeros([2, 4, 3])])
