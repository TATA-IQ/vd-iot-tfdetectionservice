...
class VRDRelationDetectionEvaluatorTest(tf.test.TestCase):
    def test_vrdrelation_evaluator(self):
        ...
        groundtruth_box_tuples1 = np.array(
            [([0, 0, 1, 1], [1, 1, 2, 2]), ([0, 0, 1, 1], [1, 2, 2, 3])], dtype=vrd_evaluation.vrd_box_data_type
        )
        ...
        detected_box_tuples = np.array(
            [([0, 0.3, 1, 1], [1.1, 1, 2, 2]), ([0, 0, 1, 1], [1, 1, 2, 2]), ([0.5, 0, 1, 1], [1, 1, 3, 3])],
...
class VRDDetectionEvaluationTest(tf.test.TestCase):
    def setUp(self):
        ...
        image_key = "img1"
        detected_box_tuples = np.array(
            [([0, 0.3, 1, 1], [1.1, 1, 2, 2]), ([0, 0, 1, 1], [1, 1, 2, 2])], dtype=vrd_evaluation.vrd_box_data_type
        )
